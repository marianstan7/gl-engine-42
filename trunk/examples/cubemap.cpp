...
// Last update Thu Jun 21 02:16:42 2012 loick michard
//
...
public:
  ...
  void initScene()
  {
    ...
    gle::DirectionalLight* light = new gle::DirectionalLight(gle::Vector3f(0, 0, 1.0),
							     gle::Colorf(0.8, 0.8, 0.8));
    *_scene << _camera;// << _light;
    ...
    //loader->setTexturesPath("./models/mustang/");
    //gle::Scene::Node* model = loader->load("./models/mustang/Ford Mustang GT Concept.lwo", NULL);
    //gle::Scene::Node* model = _loader->load("./models/textured_cube.obj", new gle::Material());
    gle::Texture* tex = new gle::Texture("./examples/cubemaps/opensea/posx.png");
